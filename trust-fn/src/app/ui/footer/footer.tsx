        ...
        <div className={styles.socialMedia}>
          ...
          <div className={styles.socialIcons}>
            <a href="https://twitter.com/pitechrwanda" target="_blank" rel="noopener noreferrer">
              <svg viewBox="0 0 13 12" xmlns="http://www.w3.org/2000/svg" fill="#fff" role="img" aria-hidden="true" className={styles['x-icon']}><mask id="XIcon-mask-:R53aacd6dd9l6:"><g clip-path="url(#x-icon_svg__x-icon_svg__a)" fill="none" stroke="#fff" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M9.323 11.586L.875.375h2.802l8.448 11.211H9.323zM11.727.375L7.273 5.151m-6 6.436l4.45-4.773"></path></g><defs><clipPath id="x-icon_svg__x-icon_svg__a"><path fill="#fff" d="M.5 0h12v12H.5z"></path></clipPath></defs></mask><g mask="url(#XIcon-mask-:R53aacd6dd9l6:)"><rect width="100%" height="100%" fill="currentColor"></rect></g></svg>
            </a>
            <a href="https://linkedin.com/company/pitechrwanda" target="_blank" rel="noopener noreferrer">
              <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#fff" role="img" aria-hidden="true" className={styles['x-icon']}>
                <mask id="LinkedInIcon-mask">
                  <g clip-path="url(#linkedin-icon_svg__clip)" fill="none" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
